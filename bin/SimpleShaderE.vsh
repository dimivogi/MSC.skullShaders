...
dp3 r7.w , v0 , v0
rsq r7.w , r7.w
mul r7.xyz , v0.xyz , r7.w	// normalize the local space position, in order to get texture coordinates, since we have only one model and it's center is at (0,0,0)

add r7.w , r7.z , c25.z	// we need diversity so we are adding a value to the z component and then we divide the vector by that value
rcp r7.w , r7.w
...
////Do Colour Stuff////
mov oD1 , r6			// send ambient , diffuse and specular lighting to the diffuse colour output reg
mov oT0 , r7.xy			// send the default texture coords to the texture output reg
//////////////////////